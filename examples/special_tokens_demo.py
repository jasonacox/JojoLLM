...
This prototype demonstrates how to modify the Jojo project to use 
special tokens for chat templates instead of plain text markers.
...
def main():
    print("=== Jojo Special Tokens Implementation Demo ===\n")
...
Human: That's hilarious! Tell me more about yourself.
Assistant: I'm an AI assistant here to help you with your questions and tasks. I can provide information, answer queries, and even tell jokes!"""
    ...
    dialogues = [
        "Hello, how are you?__eou__I'm fine, thank you!__eou__What can you do?__eou__I can assist you with various tasks.",
        "Hi there!__eou__Hello!__eou__How's it going?__eou__Pretty good, thanks for asking!"
    ]
    ...
    # Example of prompt preparation for generation
    ...
    # Here you would typically call the model's generate function with the prepared prompt
    # e.g. model.generate(prepared_prompt)
