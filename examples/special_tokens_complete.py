...
Human: That's a good one! Tell me another.
Assistant: What do you get when you cross a snowman and a dog? Frostbite!
Human: Haha, I love it! Okay, last one.
Assistant: Why don't scientists trust atoms? Because they make up everything!"""
    ...
    # Setup tokenizer (example, not functional without actual implementation)
    enc = setup_tokenizer()
    print("\n=== Tokenizer Setup Complete ===")
    
    # Example dialogues for formatting
    example_dialogues = [
        "Hello, how are you?__eou__I'm fine, thank you!__eou__What can you do?__eou__I can assist you with a variety of tasks.",
        "Hi there!__eou__Greetings! How can I help you today?__eou__Tell me a story.__eou__Once upon a time..."
    ]
    ...
    prompt = "Human: What's the weather like today?\n\nAssistant: It's sunny and warm. A great day to be outside!"
